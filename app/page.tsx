...
// Server-side safe static content
...
// Dynamic client component with proper SSR fallback
const InteractiveHomePage = dynamic(() => import('@/components/HomeClient'), {
  ssr: false,
  loading: () => <HomePageContent />
})
