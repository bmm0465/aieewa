"use strict";(()=>{var e={};e.id=188,e.ids=[188],e.modules={9415:e=>{e.exports=require("@langchain/core/output_parsers")},6666:e=>{e.exports=require("@langchain/core/prompts")},8775:e=>{e.exports=require("@langchain/openai")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},5477:e=>{e.exports=require("punycode")},2781:e=>{e.exports=require("stream")},7310:e=>{e.exports=require("url")},9796:e=>{e.exports=require("zlib")},6988:(e,a,r)=>{r.r(a),r.d(a,{headerHooks:()=>q,originalPathname:()=>P,patchFetch:()=>C,requestAsyncStorage:()=>b,routeModule:()=>v,serverHooks:()=>f,staticGenerationAsyncStorage:()=>A,staticGenerationBailout:()=>g});var t={};r.r(t),r.d(t,{POST:()=>y,dynamic:()=>x,maxDuration:()=>w,runtime:()=>h});var i=r(5419),s=r(9108),n=r(9678),o=r(8070),c=r(8775),l=r(6666),_=r(9415),u=r(5256);let p=u.Ry({analytical_score_1:u.Rx().min(0).max(2).describe("분석적 채점 1 (과제수행: 내용의 적절성 및 완성도)"),analytical_score_2:u.Rx().min(0).max(2).describe("분석적 채점 2 (구성: 응집성 및 일관성)"),analytical_score_3:u.Rx().min(0).max(2).describe("분석적 채점 3 (언어사용: 어휘 및 어법의 정확성)"),holistic_score:u.Km(["A","B","C"]).describe("총체적 채점 수준"),total_score:u.Rx().min(0).max(6).describe("총점 (6점 만점)"),ai_feedback:u.Z_().describe("AI 피드백")});class m{constructor(){this.llm=new c.ChatOpenAI({modelName:"gpt-4o",temperature:.1,openAIApiKey:process.env.OPENAI_API_KEY})}async evaluateAnswer(e,a,r){let t=l.ChatPromptTemplate.fromMessages([["system",`당신은 초등 영어 평가 전문가입니다. 
